...
import { activityLabels, documentTypeLabels, partnerCooperationPeriodOptions, studyProgramOptions, type PartnerAndFacultyProfile, type StudyProgram } from '@/types/submission.type';
