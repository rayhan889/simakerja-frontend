import { activityLabels, type ActivityType, type LecturerSubmissionPagination } from "@/types/submission.type";
import { createColumnHelper, type ColumnDef } from "@tanstack/react-table";
import { Eye } from "lucide-react";


const submissionsMoaIaForLecturerColumnHelper = createColumnHelper<LecturerSubmissionPagination>();

export interface SubmissionsMoaIaForLecturerColumnOptions {
    onViewDetail?: (period: string, partnerName: string, activityType: string) => void;
}

export function getSubmissionsMoaIaForLecturerColumns(
    options: SubmissionsMoaIaForLecturerColumnOptions = {}
): ColumnDef<LecturerSubmissionPagination, never>[] {
    return [
        submissionsMoaIaForLecturerColumnHelper.accessor('period', {
        ...
        submissionsMoaIaForLecturerColumnHelper.accessor('partnerName', {
            header: 'Nama Mitra',
            cell: (info) => {
        ...
        submissionsMoaIaForLecturerColumnHelper.accessor('activityType', {
        ...
        submissionsMoaIaForLecturerColumnHelper.accessor('totalSubmissions', {
        ...
        submissionsMoaIaForLecturerColumnHelper.display({
            id: 'actions', 
            header: '',    
            cell: (info) => {
